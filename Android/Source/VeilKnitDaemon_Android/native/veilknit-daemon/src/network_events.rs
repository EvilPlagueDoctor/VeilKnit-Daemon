...
/// Monotonic operation timer. Wall-clock timestamps are supplied by the event
/// envelope; durations always use `Instant` so clock corrections cannot make a
/// completed operation appear negative or unreasonably long.
#[derive(Debug)]
